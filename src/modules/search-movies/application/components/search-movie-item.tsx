...
export const SearchMovieItem = ({
	...
	return (
		<li className="flex justify-between py-4 border-b border-gray-800 last-of-type:border-none">
			...
			{alreadyAdded ? (
				...
				<button
					...
					className="whitespace-nowrap font-medium rounded-lg text-sm px-3 py-2 ml-3 sm:ml-4 h-fit text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-800 shadow-lg shadow-blue-800/80 text-center"
				>
